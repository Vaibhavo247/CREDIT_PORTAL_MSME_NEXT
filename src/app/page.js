...
function LoginContent() {
  ...
  const handleLogin = () => {
    // Redirect directly to the IBM SSO login endpoint
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-tr from-brand-blue via-brand-blue-hover to-[#04335c] text-white p-6">
      ...
      {/* Login Card */}
      <div className="w-full max-w-md p-8 md:p-10 rounded-3xl bg-white/5 backdrop-blur-md border border-white/10 shadow-2xl flex flex-col items-center hover-scale select-none relative">
        ...
        <h2 className="text-2xl font-bold tracking-wide text-white mb-2 text-center">
          Suryoday Bank
        </h2>
        ...
        <div className="mt-8 text-[11px] text-white/40 text-center tracking-wide leading-normal">
